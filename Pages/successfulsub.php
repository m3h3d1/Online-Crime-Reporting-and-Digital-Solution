              ...
              <div class="col-lg-12">
                <div class="content">
                  <h3>Your complaint has been submitted</h3>
                    ...
                    <a href="./complaint.php"><button type="button" class="btn btn-success">Download it</button></a>
                    <a href="#"><button type="button" class="btn btn-secondary">Check history</button></a>
                    <a href="./complaint.php"><button type="button" class="btn btn-dark">Submit another</button></a>
