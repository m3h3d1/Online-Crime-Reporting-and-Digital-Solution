...
<div class="col-md-12 c-head">
            ...
            <div class="col-md-6 a-data">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Bangladesh Police is committed to enforce law, maintain social order, reduce fear of crime,enhance public safety and ensure internal security with the active support of the community.</p>
                     </div>
                </div>
            </div>
            <div class="col-md-6 a-data">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">To provide quality service by competent, efficient and dedicated professionals enjoying trust and respect of citizens to make Bangladesh a better and safer place to live.</div>
                </div>
            </div>
            </div>
            <div class="clr"></div>
    <div class="col-md-12 act">
            ...
            <div class="col-md-3 ac-data">
                    <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Internal Security</h4>
                        <ul>
            ...
            <div class="col-md-3 ac-data">
                    <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Social Integration</h4>
                        <ul>
            ...
            <div class="col-md-3 ac-data">
                    <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Performing Internationally</h4>
                        <ul>
...
It strives to track citizen’s engagement in policing and theiaczr quest for better service, better value and better management. It envisages a new structure erected on the bedrock of information and communication technology, skill adequacy, knowledge-based initiatives and community partnership that will be styled on a schema of cascading change to set a stage for a clear interface between police and citizenry.
